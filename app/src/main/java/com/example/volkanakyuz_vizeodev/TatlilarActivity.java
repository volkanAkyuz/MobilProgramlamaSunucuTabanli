...
public class TatlilarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        va_title.setText("Amasya Yöresel Tatlılar");
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    if(va_document.exists()){
                        ListView va_listView = findViewById(R.id.va_YoreselTatlilarListView);
    ...
    void va_listViewOnClick(ListView listView_va)
    {
        listView_va.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent va_intent = new Intent(TatlilarActivity.this, TatliActivity.class);

...
public class YemekActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        va_title.setText("Yöresel Yemekler");
        String va_index = getIntent().getStringExtra("va_index");
        ImageView va_imageView = findViewById(R.id.va_yemekimage);
        TextView va_isim_txt = findViewById(R.id.va_yemekisim);
        TextView va_bilgi_txt = findViewById(R.id.va_yemekbilgi);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()){
                    ...
                    if(va_document.exists()){
                        StorageReference va_imageReference = va_storageReference.child("yemekler/yemek"+va_index+".jpg");
                        try{

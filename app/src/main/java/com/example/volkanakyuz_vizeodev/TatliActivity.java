...
public class TatliActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        va_title.setText("Yöresel Tatlılar");
        String va_index = getIntent().getStringExtra("va_index");
        ImageView va_imageView = findViewById(R.id.va_tatliimage);
        TextView va_isim_txt = findViewById(R.id.va_tatliisim);
        TextView va_bilgi_txt = findViewById(R.id.va_tatlibilgi);
        ...
        DocumentReference va_reference = va_db.collection("Tatlilar").document("zRimpvNdiv6Mcutof3CI");
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    if(va_document.exists()){
                        StorageReference va_imageReference = va_storageReference.child("tatlilar/tatli"+va_index+".jpg");
                        try{
